...
class Card extends _react.Component {
  constructor(...args) {
    ...
    (0, _defineProperty2.default)(this, "renderBody", () => {
      if (this.props.customCardLayout) {
        ...
        return _react.default.createElement("span", null, _react.default.createElement(_Base.CardHeader, null, _react.default.createElement(_Base.CardTitle, null, title)), _react.default.createElement(_Base.Detail, null, description), tags && _react.default.createElement(_Base.Footer, null, tags.map(tag => _react.default.createElement(_Tag.default, (0, _extends2.default)({
          key: tag.title
        }, tag, {
  ...
  render() {
    const _this$props4 = this.props,
          ...
          otherProps = (0, _objectWithoutProperties2.default)(_this$props4, ["menu", "id", "cardStyle", "editable", "hideCardDeleteIcon", "customCardLayout", "dragStyle"]);
    ...
    }, otherProps), this.renderBody(), editable && !hideCardDeleteIcon && _react.default.createElement(_Elements.MenuDropdown, null, menu));
  }
